...
Agent guidance lives under `skills/writing/` in the repository root. The `paper-writing` skill
...
`skills/writing/paper-writing`. Private papers and source notes remain outside the
repository. The [writing collection README](../../../skills/writing/README.md) documents the optional
corpus.
