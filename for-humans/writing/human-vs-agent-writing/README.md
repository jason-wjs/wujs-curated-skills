...
The article draws on `skills/writing/humanizer`, `skills/writing/general-writing`,
`skills/writing/better-usage`, `skills/writing/writing-cadence`, and
`skills/writing/academic-voice`, together with the non-autoregressive, abstract,
...
License. The companion `../ACKNOWLEDGMENTS.md` and the component license files
