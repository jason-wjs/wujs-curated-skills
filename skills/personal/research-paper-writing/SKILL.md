...
Adapted from `Master-cai/Research-Paper-Writing-Skills` under the MIT License.
The upstream skill credits Prof. Peng Sida's public research-writing notes and
`pengsida/learning_research` as the primary methodology source.
