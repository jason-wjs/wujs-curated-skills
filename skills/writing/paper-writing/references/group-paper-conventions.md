...
These are observations and optional patterns from reference authors. The task,
source evidence, and shared editing defaults take precedence over suggested
sentence counts, section sequences, or phrasing.
...
[paper-writing](../SKILL.md#draft-and-revise). If no corpus was
...
These abstracts often use the following moves; combine, reorder, or omit them
according to the evidence and venue:
...
The following sequence illustrates these papers; adapt it to the contribution:
...
For sentence examples, consult [sentence-style.md](sentence-style.md) when
needed. Apply the shared editing defaults without adding another style pass.
